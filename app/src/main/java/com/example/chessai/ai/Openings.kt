...
object Openings {
    val openingBook: Map<String, List<Pair<Pair<Int, Int>, Pair<Int, Int>>>> = mapOf(
        "whiteE2E4" to listOf((4 to 6) to (4 to 4), (2 to 6) to (2 to 4), (5 to 6) to (5 to 5)),
        "whiteC2C4" to listOf((4 to 6) to (4 to 4), (2 to 6) to (2 to 4)),
        "whiteG1F3" to listOf((4 to 6) to (4 to 4), (6 to 6) to (6 to 4)),
        "whiteB1C3" to listOf((4 to 6) to (4 to 4), (1 to 6) to (1 to 5)),
        "whiteF2F4" to listOf((3 to 6) to (3 to 5), (4 to 6) to (4 to 5)),
        "whiteG2G3" to listOf((4 to 6) to (4 to 4), (6 to 6) to (6 to 4)),
        "whiteA2A3" to listOf((4 to 6) to (4 to 4), (0 to 6) to (0 to 5)),
        "whiteA2A4" to listOf((4 to 6) to (4 to 4), (0 to 6) to (0 to 5)),
        "whiteB2B3" to listOf((4 to 6) to (4 to 4), (1 to 6) to (1 to 5)),
        "whiteB2B4" to listOf((4 to 6) to (4 to 4), (1 to 6) to (1 to 5)),
        "whiteC2C3" to listOf((4 to 6) to (4 to 4), (2 to 6) to (2 to 5)),
        "whiteD2D3" to listOf((3 to 6) to (3 to 4), (4 to 6) to (4 to 5)),
        "whiteD2D4" to listOf((3 to 6) to (3 to 4), (4 to 6) to (4 to 5)),
        "whiteE2E3" to listOf((4 to 6) to (4 to 4), (5 to 6) to (5 to 5)),
        "whiteF2F3" to listOf((4 to 6) to (4 to 4), (5 to 6) to (5 to 5)),
        "whiteG2G4" to listOf((4 to 6) to (4 to 4), (6 to 6) to (6 to 4)),
        "whiteH2H3" to listOf((4 to 6) to (4 to 4), (7 to 6) to (7 to 5)),
        "whiteH2H4" to listOf((4 to 6) to (4 to 4), (7 to 6) to (7 to 5)),
        "whiteG1H3" to listOf((4 to 6) to (4 to 4), (6 to 6) to (6 to 4)),
        "whiteB1A3" to listOf((4 to 6) to (4 to 4), (1 to 6) to (1 to 5))
    )

    fun detectSimpleOpeningSignature(chessModel: ChessModel): String? {
        fun hasWhitePawnAt(col: Int, row: Int): Boolean {
            val p = chessModel.pieceAt(col, row) ?: return false
            return p.player == ChessPlayer.WHITE && p.rank == ChessRank.PAWN
        }
        fun hasWhiteKnightAt(col: Int, row: Int): Boolean {
            val p = chessModel.pieceAt(col, row) ?: return false
            return p.player == ChessPlayer.WHITE && p.rank == ChessRank.KNIGHT
        }
